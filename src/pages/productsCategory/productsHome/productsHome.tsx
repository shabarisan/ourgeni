...
import categoryHomeStyles from "./productHomeStyles";
                                ...
                                <Card className={classes.category_box}>
                                    <CardContent className={classes.card_content}>
                                        ...
                                        <CardActions className={classes.category_btn_bx}>
                                            <Link className={classes.all_category_btn} component={RouterLink} to={`/products/product-list/${item.id}`}> View All</Link>
                                        </CardActions>
                                    </CardContent>
                                </Card>
                            </Grid>
