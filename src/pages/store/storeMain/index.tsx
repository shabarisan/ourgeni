...
import StoreDetails from '../storeDetails/storeDetail';
            ...
            <Grid container >
                <Grid item xs={12} sm={12} >
                    <Switch>
                        ...
                        <Route exact path={path} component={StoreHome} />
                        
                        <Route exact path={`${path}/store-list`} component={StoreList} />
                       
                        <Route exact path={`${path}/storeDetail/:id`} component={StoreDetails} />
