...
import storeDetailsStyles from "./storeDetailsStyles";
...
const StoreDetails = (props) => {
  ...
  const classes = storeDetailsStyles();
...
console.log(1111111111111,details)
              ...
              <div className="comment-lists" style={{ border: "none" }}>
               ...
               <div className="comment-content">
                ...
                <p>
                  ...
                  do eiusmod tempor #incididunt ero labore et dolore magna
                  ...
                  elit, sed do eiusmod tempor #incididunt ero labore et dolore
